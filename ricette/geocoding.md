...
- si aggiunge una colonna che verrà usata per fare il _geocoding_, in modo che il dato di input contenga sia l'indirizzo, che il comune di riferimento (altrimenti il geocoding sarebbe impossibile), con la formula `value + ', ' + cells["comune"].value + ', Italia'`
